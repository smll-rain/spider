...
class LagouSpider(object):
    def __init__(self):
        self.headers = {
            "Cookie": "_ga=GA1.2.648121662.1540282185; user_trace_token=20181023160944-0022c75c-d69b-11e8-80a4-5254005c3644; LGUID=20181023160944-0022cfc9-d69b-11e8-80a4-5254005c3644; JSESSIONID=ABAAABAAAIAACBI840BBC34E8DCDC8991AE72E1535D51B6; _gid=GA1.2.1541069417.1543887253; index_location_city=%E6%B7%B1%E5%9C%B3; WEBTJ-ID=20181204100339-16776f4e1dc2c9-0218dfb99f0d35-6313363-921600-16776f4e1dd87e; sensorsdata2015jssdkcross=%7B%22distinct_id%22%3A%221671bca9b041cb-06ec179635988e-8383268-921600-1671bca9b051118%22%2C%22%24device_id%22%3A%221671bca9b041cb-06ec179635988e-8383268-921600-1671bca9b051118%22%2C%22props%22%3A%7B%22%24latest_traffic_source_type%22%3A%22%E7%9B%B4%E6%8E%A5%E6%B5%81%E9%87%8F%22%2C%22%24latest_referrer%22%3A%22%22%2C%22%24latest_referrer_host%22%3A%22%22%2C%22%24latest_search_keyword%22%3A%22%E6%9C%AA%E5%8F%96%E5%88%B0%E5%80%BC_%E7%9B%B4%E6%8E%A5%E6%89%93%E5%BC%80%22%7D%7D; Hm_lvt_4233e74dff0ae5bd0a3d81c6ccf756e6=1543890249,1543890455,1543890469,1543897512; X_HTTP_TOKEN=a46b992d41da9a42430b65613da78fbf; TG-TRACK-CODE=search_code; SEARCH_ID=d46a21aa7cc24cddbc9bb8d6bc165270; _gat=1; Hm_lpvt_4233e74dff0ae5bd0a3d81c6ccf756e6=1543916791; LGSID=20181204174632-7b1ce6fe-f7a9-11e8-8cbc-5254005c3644; PRE_UTM=; PRE_HOST=; PRE_SITE=https%3A%2F%2Fwww.lagou.com%2Fjobs%2Flist_python%25E6%2595%25B0%25E6%258D%25AE%25E5%2588%2586%25E6%259E%2590%3Fpx%3Ddefault%26city%3D%25E5%258E%25A6%25E9%2597%25A8; PRE_LAND=https%3A%2F%2Fwww.lagou.com%2Fjobs%2Flist_python%25E5%2590%258E%25E7%25AB%25AF%3Fcity%3D%25E5%258E%25A6%25E9%2597%25A8%26cl%3Dfalse%26fromSearch%3Dtrue%26labelWords%3D%26suginput%3D; LGRID=20181204174644-827274d7-f7a9-11e8-8cbc-5254005c3644",
            "Host": "www.lagou.com",
            'Origin': 'https://www.lagou.com',
            'Referer': 'https://www.lagou.com/jobs/list_python%E5%90%8E%E7%AB%AF?city=%E5%8E%A6%E9%97%A8&cl=false&fromSearch=true&labelWords=&suginput=',
        ...
        self.post_data = {'first': 'false', 'kd': 'Python后端开发'}  # 这是请求网址的一些参数
    ...
    def send_requests(self, url, page):
        ...
        try:
            response = requests.post(url + str(page), data=self.post_data, headers=self.headers, verify=False,
                                     proxies=proxies)
            clientIp = json.loads(response.content).get('clientIp')
            while clientIp:
                time.sleep(0.001)
